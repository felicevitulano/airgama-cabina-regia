...
1. **Flusso Dati** — dashboard grafica iniziale: la **pipeline order-to-cash** con le 8 fasi (Ordini → Controllo Credito → Produzione → Magazzino → Picking → Spedizione → Fatture → Incassi) per vedere come avanzano le informazioni, con stato a semaforo per fase. **Cliccando una fase si vedono le ultime 5 righe lette dal gestionale** (con KPI e stato), oltre a KPI generali e **punti di attenzione** cliccabili.
