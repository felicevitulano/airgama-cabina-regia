...
VoxBI interpreta le domande in linguaggio naturale con un **parser a regole offline** (nessuna dipendenza, nessuna chiave) e costruisce KPI, grafici e narrazione sul cubo sintetico. Esiste anche un motore AI opzionale (Claude) che gira **solo in locale** e non fa parte di questo repository pubblico.
